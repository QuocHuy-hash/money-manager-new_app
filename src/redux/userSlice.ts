...
export const login = createAsyncThunk("user/login", async (data: any, { rejectWithValue }) => {
    try {
...
export const verifyOTP = createAsyncThunk("user/verify-email", async (data: any, { rejectWithValue }) => {
    try {
...
export const resendOTP = createAsyncThunk("user/resend-otp", async (data: any, { rejectWithValue }) => {
    try {
        const { email } = data;
        console.log("data", data);
        const response = await axios.post(`${API_URL}/user/resend-email`, { email });
        return response.data;
    } catch (error: any) {
        return rejectWithValue(serializeError(error));
    }
