...
export const getMonthlySaving = createAsyncThunk("goals/get-month-saving", async (goalId:number) => {
    return await makeRequest(`/goal/get-monthly-saving?goalId=${goalId}`, 'get');
});
export const createGoals = createAsyncThunk("goals/add", async (data: any) => {
    return await makeRequest("/goal/add", 'post', data);
});
//mothySaving
export const updateSavingAmount = createAsyncThunk("goals/update-saving-amount", async (data: any) => {
